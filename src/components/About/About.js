...
<Link to='/about' className="subnav_link"><h3>About</h3></Link>
<Link to='/about/history' className="subnav_link"><h3>History</h3></Link>
<Link to='/about/contact' className="subnav_link"><h3>Contact</h3></Link>
